...
//   }]
// }
typedef struct ten_msg_conversion_operation_per_property_rule_t {
  ...
  union {
    ten_msg_conversion_operation_per_property_rule_from_original_t
        from_original;
    ten_msg_conversion_operation_per_property_rule_fixed_value_t fixed_value;
  } u;
...
ten_msg_conversion_operation_per_property_rule_convert(
    ten_msg_conversion_operation_per_property_rule_t *self,
    ten_shared_ptr_t *msg, ten_shared_ptr_t *new_msg, ten_error_t *err);

TEN_RUNTIME_PRIVATE_API ten_msg_conversion_operation_per_property_rule_t *
ten_msg_conversion_operation_per_property_rule_from_json(ten_json_t *json,
                                                         ten_error_t *err);

TEN_RUNTIME_PRIVATE_API ten_json_t *
ten_msg_conversion_operation_per_property_rule_to_json(
