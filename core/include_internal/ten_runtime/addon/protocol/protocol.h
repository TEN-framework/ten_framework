...
TEN_RUNTIME_PRIVATE_API ten_addon_create_protocol_info_t *
ten_addon_create_protocol_into_create(
    const char *uri, TEN_PROTOCOL_ROLE role,
    ten_env_addon_on_create_protocol_async_cb_t cb, void *user_data);

TEN_RUNTIME_PRIVATE_API void ten_addon_create_protocol_into_destroy(
