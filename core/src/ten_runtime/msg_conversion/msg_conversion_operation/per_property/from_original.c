...
// information.
//
#include "include_internal/ten_runtime/msg_conversion/msg_conversion_operation/per_property/from_original.h"
...
static void ten_msg_conversion_operation_per_property_rule_from_original_init(
...
void ten_msg_conversion_operation_per_property_rule_from_original_deinit(
    ten_msg_conversion_operation_per_property_rule_from_original_t *self) {
  TEN_ASSERT(self, "Invalid argument.");
...
static ten_value_t *
ten_msg_conversion_operation_per_property_rule_from_original_get_value(
    ten_msg_conversion_operation_per_property_rule_from_original_t *self,
...
bool ten_msg_conversion_operation_per_property_rule_from_original_convert(
    ten_msg_conversion_operation_per_property_rule_from_original_t *self,
...
void ten_msg_conversion_operation_per_property_rule_from_original_from_json(
    ten_msg_conversion_operation_per_property_rule_from_original_t *self,
    ten_json_t *json) {
  TEN_ASSERT(self, "Invalid argument.");
  TEN_ASSERT(json, "Invalid argument.");

  ten_msg_conversion_operation_per_property_rule_from_original_init(self);
  ten_string_init_formatted(&self->original_path,
                            ten_json_peek_string_value(ten_json_object_peek(
                                json, TEN_STR_ORIGINAL_PATH)));
}

bool ten_msg_conversion_operation_per_property_rule_from_original_to_json(
    ten_msg_conversion_operation_per_property_rule_from_original_t *self,
...
bool ten_msg_conversion_operation_per_property_rule_from_original_from_value(
    ten_msg_conversion_operation_per_property_rule_from_original_t *self,
  ...
  ten_msg_conversion_operation_per_property_rule_from_original_init(self);
  ten_string_init_formatted(&self->original_path,
                            ten_value_peek_c_str(ten_value_object_peek(
                                value, TEN_STR_ORIGINAL_PATH)));

  return true;
}

void ten_msg_conversion_operation_per_property_rule_from_original_to_value(
    ten_msg_conversion_operation_per_property_rule_from_original_t *self,
    ten_value_t *value) {
  TEN_ASSERT(self, "Invalid argument.");
