...
void ten_app_on_configure_done(ten_env_t *ten_env) {
  ...
  // store.
  //
  // Addonloader and Protocol addons do not implement the on_init() function,
  // so after the following method is called, all addon loaders and protocols
  // will be registered and added to the addon store.
