...
bool ten_env_tester_proxy_check_integrity(ten_env_tester_proxy_t *self) {
...
ten_env_tester_proxy_t *ten_env_tester_proxy_create(
  ...
  if (!ten_env_tester) {
    const char *err_msg = "Create ten_env_tester_proxy without specifying ten.";
...
bool ten_env_tester_proxy_notify(ten_env_tester_proxy_t *self,
                                 ten_tester_notify_func_t notify_func,
