...
static PyObject *ten_py_app_close(PyObject *self, PyObject *args) {
  ...
  TEN_ASSERT(self && ten_py_app_check_integrity(
                         py_app,
                         // TEN_NOLINTNEXTLINE(thread-check)
                         // thread-check: this function is designed to be called
                         // from any thread (not just the app thread).
                         false),
             "Invalid argument.");
...
static void ten_py_app_destroy(PyObject *self) {
  ...
  TEN_ASSERT(py_app && ten_py_app_check_integrity(
                           py_app,
                           // TEN_NOLINTNEXTLINE(thread-check)
                           // thread-check: this function is designed to be
                           // called from any thread (not just the app thread).
                           false),
             "Invalid argument.");
