...
//
export const EXTENSION_STORE_WIDGET_ID = "extension-store";
export const EXTENSION_STORE_POPUP_ID = EXTENSION_STORE_WIDGET_ID + "-popup";

export const GRAPH_SELECT_WIDGET_ID = "graph-select";
...
export const DOC_REF_WIDGET_ID = "doc-ref";
export const DOC_REF_POPUP_ID = DOC_REF_WIDGET_ID + "-popup";

export const PREFERENCES_WIDGET_ID = "preferences";
