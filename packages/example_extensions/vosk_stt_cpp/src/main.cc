...
namespace vosk_stt_cpp {

class vosk_stt_cpp_t : public ten::extension_t {
 public:
  explicit vosk_stt_cpp_t(const char *name) : extension_t(name) {}
...
TEN_CPP_REGISTER_ADDON_AS_EXTENSION(vosk_stt_cpp, vosk_stt_cpp_t);
