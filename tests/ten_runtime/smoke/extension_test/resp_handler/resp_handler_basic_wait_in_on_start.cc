...
TEN_CPP_REGISTER_ADDON_AS_EXTENSION(resp_handler_basic_wait_in_on_start__extension_1,
                                          test_extension_1);
TEN_CPP_REGISTER_ADDON_AS_EXTENSION(resp_handler_basic_wait_in_on_start__extension_2,
                                          test_extension_2);
