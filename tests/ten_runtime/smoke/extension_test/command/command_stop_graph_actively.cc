...
TEN_CPP_REGISTER_ADDON_AS_EXTENSION_GROUP(
    command_stop_graph_actively__extension_group_1, test_extension_group_1);
TEN_CPP_REGISTER_ADDON_AS_EXTENSION_GROUP(
    command_stop_graph_actively__extension_group_2, test_extension_group_2);
TEN_CPP_REGISTER_ADDON_AS_EXTENSION_GROUP(
    command_stop_graph_actively__extension_group_3, test_extension_group_3);
        ...
        R"({
             "_ten": {
               ...
               "nodes": [{
                 ...
                 "name": "command_stop_graph_actively_1",
                 "addon": "command_stop_graph_actively__extension_group_1",
                 "app": "msgpack://127.0.0.1:8001/"
               },{
                 "type": "extension_group",
                 "name": "command_stop_graph_actively_2",
                 "addon": "command_stop_graph_actively__extension_group_2",
                 "app": "msgpack://127.0.0.1:8002/"
               },{
                 "type": "extension_group",
                 "name": "command_stop_graph_actively_3",
                 "addon": "command_stop_graph_actively__extension_group_3",
