...
TEN_CPP_REGISTER_ADDON_AS_EXTENSION_GROUP(
    command_stop_graph_actively_through_cmd_dest__extension_group_1,
    test_extension_group_1);
TEN_CPP_REGISTER_ADDON_AS_EXTENSION_GROUP(
    command_stop_graph_actively_through_cmd_dest__extension_group_2,
    test_extension_group_2);
TEN_CPP_REGISTER_ADDON_AS_EXTENSION_GROUP(
    command_stop_graph_actively_through_cmd_dest__extension_group_3,
        ...
        R"({
             "_ten": {
               ...
               "nodes": [{
                 ...
                 "name": "command_stop_graph_actively_through_cmd_dest_1",
                 "addon": "command_stop_graph_actively_through_cmd_dest__extension_group_1",
                 "app": "msgpack://127.0.0.1:8001/"
               },{
                 "type": "extension_group",
                 "name": "command_stop_graph_actively_through_cmd_dest_2",
                 "addon": "command_stop_graph_actively_through_cmd_dest__extension_group_2",
                 "app": "msgpack://127.0.0.1:8002/"
               },{
                 "type": "extension_group",
                 "name": "command_stop_graph_actively_through_cmd_dest_3",
                 "addon": "command_stop_graph_actively_through_cmd_dest__extension_group_3",
