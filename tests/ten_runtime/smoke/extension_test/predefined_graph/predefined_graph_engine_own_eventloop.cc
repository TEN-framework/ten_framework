                      ...
                      "_ten": {
                        ...
                        "predefined_graphs": [{
                          ...
                          "nodes": [{
                            ...
                            "name": "predefined_graph_engine_own_eventloop__extension_group",
                            "addon": "predefined_graph_engine_own_eventloop__extension_group"
                          }]
                        }]
                      }
                    })"
...
TEST(ExtensionTest, PredefinedGraphEngineOwnEventloop) {  // NOLINT
  ...
  // TODO(Wei): client->send_json would cause thread safety issue, need to have
