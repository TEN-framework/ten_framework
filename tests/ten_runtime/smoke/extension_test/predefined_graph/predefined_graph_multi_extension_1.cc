                      ...
                      "_ten": {
                        ...
                        "predefined_graphs": [{
                          ...
                          "nodes": [{
                            ...
                            "name": "predefined_graph_multi_extension_1",
                            "addon": "predefined_graph_multi_extension_1__extension_group"
                          }],
                          "connections": [{
...
TEN_CPP_REGISTER_ADDON_AS_EXTENSION_GROUP(
    predefined_graph_multi_extension_1__extension_group, test_extension_group);
