...
TEN_CPP_REGISTER_ADDON_AS_EXTENSION_GROUP(property_set_int32__extension_group,
      ...
      R"({
           "_ten": {
             ...
             "nodes": [{
               ...
               "name": "property_set_int32__extension_group",
               "addon": "property_set_int32__extension_group",
