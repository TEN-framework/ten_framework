...
TEN_CPP_REGISTER_ADDON_AS_EXTENSION_GROUP(
    property_start_graph_cmd__extension_group, test_extension_group);
...
TEST(ExtensionTest, PropertyConnectCmd) {  // NOLINT
      ...
      R"({
           "_ten": {
             ...
             "nodes": [{
               ...
               "name": "property_start_graph_cmd",
               "addon": "property_start_graph_cmd__extension_group",
  ...
  command["_ten"]["nodes"][1]["property"]["test_prop"] = CONNECT_CMD_PROP_VAL;
