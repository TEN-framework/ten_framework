...
TEN_CPP_REGISTER_ADDON_AS_EXTENSION_GROUP(property_get_int32__extension_group,
      ...
      R"({
           "_ten": {
             ...
             "nodes": [{
               ...
               "name": "property_get_int32__extension_group",
               "addon": "property_get_int32__extension_group",
