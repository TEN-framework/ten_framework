 ...
 public:
  ...
  void on_cmd(ten::ten_env_t &ten_env,
    ...
    if (json["_ten"]["name"] == "hello_world") {
      ...
      nlohmann::json timer_cmd_json = R"({
                          "_ten": {
                          "type": "timer",
                          "dest": [{
                            "app": "localhost"
...
TEN_CPP_REGISTER_ADDON_AS_EXTENSION_GROUP(timer_two_shot__extension_group,
      ...
      R"({
           "_ten": {
             ...
             "nodes": [{
               ...
               "name": "timer_two_shot__extension_group",
               "addon": "timer_two_shot__extension_group",
