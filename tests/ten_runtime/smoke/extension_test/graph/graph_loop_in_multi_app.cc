...
TEN_CPP_REGISTER_ADDON_AS_EXTENSION_GROUP(
    graph_loop_in_multi_app__extension_group_1, test_extension_group_1);
TEN_CPP_REGISTER_ADDON_AS_EXTENSION_GROUP(
    graph_loop_in_multi_app__extension_group_2, test_extension_group_2);
TEN_CPP_REGISTER_ADDON_AS_EXTENSION_GROUP(
    graph_loop_in_multi_app__extension_group_3, test_extension_group_3);
        ...
        R"({
             "_ten": {
               ...
               "nodes": [{
                 ...
                 "name": "graph_loop_in_multi_app__extension_group_1",
                 "addon": "graph_loop_in_multi_app__extension_group_1",
                 "app": "msgpack://127.0.0.1:8001/"
               },{
                 "type": "extension_group",
                 "name": "graph_loop_in_multi_app__extension_group_2",
                 "addon": "graph_loop_in_multi_app__extension_group_2",
                 "app": "msgpack://127.0.0.1:8002/"
               },{
                 "type": "extension_group",
                 "name": "graph_loop_in_multi_app__extension_group_3",
                 "addon": "graph_loop_in_multi_app__extension_group_3",
