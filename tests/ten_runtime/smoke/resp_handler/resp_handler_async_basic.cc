...
class test_extension_1 : public ten::extension_t {
 public:
  ...
  void on_cmd(ten::ten_env_t &ten_env,
    ...
    if (std::string(cmd->get_name().c_str()) == "hello_world_1") {
    ...
    } else if (std::string(cmd->get_name().c_str()) == "hello_world_3") {
      ten_env.send_cmd(
          std::move(cmd),
          [](ten::ten_env_t &ten_env,
             std::unique_ptr<ten::cmd_result_t> cmd_result, ten::error_t *err) {
    ...
    } else if (std::string(cmd->get_name().c_str()) == "hello_world_4") {
      ...
      return;
    } else if (std::string(cmd->get_name().c_str()) == "hello_world_5") {
      auto cmd_shared =
...
class test_extension_2 : public ten::extension_t {
 public:
  ...
  void on_cmd(ten::ten_env_t &ten_env,
              std::unique_ptr<ten::cmd_t> cmd) override {
    if (std::string(cmd->get_name().c_str()) == "hello_world_1" ||
        std::string(cmd->get_name().c_str()) == "hello_world_2" ||
        std::string(cmd->get_name().c_str()) == "hello_world_3" ||
        std::string(cmd->get_name().c_str()) == "hello_world_5" ||
        std::string(cmd->get_name().c_str()) == "hello_world_6") {
      auto cmd_result = ten::cmd_result_t::create(TEN_STATUS_CODE_OK);
