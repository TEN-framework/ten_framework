...
TEN_CPP_REGISTER_ADDON_AS_EXTENSION(
    stop_test_before_on_start_done__test_extension_1, test_extension_1);
...
TEST(StandaloneTest, StopTestBeforeOnStartDone) {  // NOLINT
  auto *tester = new extension_tester_1();
  tester->set_test_mode_single(
      "stop_test_before_on_start_done__test_extension_1");
