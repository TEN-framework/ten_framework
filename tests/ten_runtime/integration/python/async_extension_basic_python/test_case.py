...
def test_async_extension_basic_python():
    ...
    app_root_path = os.path.join(base_path, "async_extension_basic_python_app")
    ...
    server_cmd = os.path.join(base_path, "async_extension_basic_python_app/bin/start")
    ...
    if not is_started:
        print("The async_extension_basic_python is not started after 30 seconds.")
    ...
    try:
        ...
        if not is_stopped:
            print("The async_extension_basic_python can not stop after 30 seconds.")
            server.kill()
