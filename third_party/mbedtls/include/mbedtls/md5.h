 ...
 *
 */
MBEDCRYPTO_EXPORT int mbedtls_md5_starts( mbedtls_md5_context *ctx );
 ...
 *
 */
MBEDCRYPTO_EXPORT int mbedtls_md5_update( mbedtls_md5_context *ctx,
 ...
 *
 */
MBEDCRYPTO_EXPORT int mbedtls_md5_finish( mbedtls_md5_context *ctx,
 ...
 *
 */
MBEDCRYPTO_EXPORT int mbedtls_md5( const unsigned char *input,
                 size_t ilen,
                 unsigned char output[16] );
