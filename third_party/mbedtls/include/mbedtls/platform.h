...
/* For size_t */
#include <stddef.h>
MBEDCRYPTO_EXPORT extern void *mbedtls_calloc( size_t n, size_t size );
MBEDCRYPTO_EXPORT extern void mbedtls_free( void *ptr );
...
/* We need FILE * */
#include <stdio.h>
MBEDCRYPTO_EXPORT extern int (*mbedtls_fprintf)( FILE *stream, const char *format, ... );
...
MBEDCRYPTO_EXPORT extern int (*mbedtls_printf)( const char *format, ... );
...
MBEDCRYPTO_EXPORT extern int (*mbedtls_snprintf)( char * s, size_t n, const char * format, ... );
...
#include <stdarg.h>
MBEDCRYPTO_EXPORT extern int (*mbedtls_vsnprintf)( char * s, size_t n, const char * format, va_list arg );
 ...
 *                         `buf` equal to `NULL`.
 */
MBEDCRYPTO_EXPORT extern void (*mbedtls_setbuf)( FILE *stream, char *buf );
 ...
 * \return                 \c 0
 */
MBEDCRYPTO_EXPORT int mbedtls_platform_set_setbuf( void (*setbuf_func)(
...
MBEDCRYPTO_EXPORT extern void (*mbedtls_exit)( int status );
...
MBEDCRYPTO_EXPORT extern int (*mbedtls_nv_seed_read)( unsigned char *buf, size_t buf_len );
MBEDCRYPTO_EXPORT extern int (*mbedtls_nv_seed_write)( unsigned char *buf, size_t buf_len );
