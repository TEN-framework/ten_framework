 ...
 *
 */
MBEDCRYPTO_EXPORT int mbedtls_sha1_starts( mbedtls_sha1_context *ctx );
 ...
 * \return         A negative error code on failure.
 */
MBEDCRYPTO_EXPORT int mbedtls_sha1_update( mbedtls_sha1_context *ctx,
 ...
 * \return         A negative error code on failure.
 */
MBEDCRYPTO_EXPORT int mbedtls_sha1_finish( mbedtls_sha1_context *ctx,
 ...
 *
 */
MBEDCRYPTO_EXPORT int mbedtls_sha1( const unsigned char *input,
                  size_t ilen,
                  unsigned char output[20] );
