 ...
 *                  \c 13).
 */
MBEDCRYPTO_EXPORT int mbedtls_ccm_starts( mbedtls_ccm_context *ctx,
                        int mode,
 ...
 */
MBEDCRYPTO_EXPORT int mbedtls_ccm_set_lengths( mbedtls_ccm_context *ctx,
                             size_t total_ad_len,
 ...
 */
MBEDCRYPTO_EXPORT int mbedtls_ccm_update_ad( mbedtls_ccm_context *ctx,
 ...
 */
MBEDCRYPTO_EXPORT int mbedtls_ccm_update( mbedtls_ccm_context *ctx,
 ...
 *                  \c plaintext_len passed to mbedtls_ccm_set_lengths().
 */
MBEDCRYPTO_EXPORT int mbedtls_ccm_finish( mbedtls_ccm_context *ctx,
                        unsigned char *tag, size_t tag_len );
