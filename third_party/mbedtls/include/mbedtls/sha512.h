 ...
 */
MBEDCRYPTO_EXPORT int mbedtls_sha512_starts( mbedtls_sha512_context *ctx, int is384 );
 ...
 * \return         A negative error code on failure.
 */
MBEDCRYPTO_EXPORT int mbedtls_sha512_update( mbedtls_sha512_context *ctx,
 ...
 * \return         A negative error code on failure.
 */
MBEDCRYPTO_EXPORT int mbedtls_sha512_finish( mbedtls_sha512_context *ctx,
 ...
 * \return         A negative error code on failure.
 */
MBEDCRYPTO_EXPORT int mbedtls_sha512( const unsigned char *input,
                    size_t ilen,
                    unsigned char *output,
                    int is384 );
