 ...
 */
MBEDCRYPTO_EXPORT int mbedtls_pk_setup_opaque( mbedtls_pk_context *ctx,
 ...
 */
MBEDCRYPTO_EXPORT int mbedtls_pk_can_do_ext( const mbedtls_pk_context *ctx, psa_algorithm_t alg,
 ...
 *
 */
MBEDCRYPTO_EXPORT int mbedtls_pk_sign_ext( mbedtls_pk_type_t pk_type,
 ...
 */
MBEDCRYPTO_EXPORT int mbedtls_pk_check_pair( const mbedtls_pk_context *pub,
 ...
 *                  error code
 */
MBEDCRYPTO_EXPORT int mbedtls_pk_write_key_der( const mbedtls_pk_context *ctx, unsigned char *buf, size_t size );
 ...
 *                  error code
 */
MBEDCRYPTO_EXPORT int mbedtls_pk_write_pubkey_der( const mbedtls_pk_context *ctx, unsigned char *buf, size_t size );
 ...
 */
MBEDCRYPTO_EXPORT int mbedtls_pk_write_pubkey_pem( const mbedtls_pk_context *ctx, unsigned char *buf, size_t size );
 ...
 * \return          0 if successful, or a specific error code
 */
MBEDCRYPTO_EXPORT int mbedtls_pk_write_key_pem( const mbedtls_pk_context *ctx, unsigned char *buf, size_t size );
