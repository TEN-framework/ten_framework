 ...
 */
MBEDCRYPTO_EXPORT size_t mbedtls_dhm_get_bitlen( const mbedtls_dhm_context *ctx );
 ...
 */
MBEDCRYPTO_EXPORT size_t mbedtls_dhm_get_len( const mbedtls_dhm_context *ctx );
 ...
 */
MBEDCRYPTO_EXPORT int mbedtls_dhm_get_value( const mbedtls_dhm_context *ctx,
