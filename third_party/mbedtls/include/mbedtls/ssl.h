 ...
 * \return            A negative error code on failure.
 */
MBEDTLS_EXPORT int mbedtls_ssl_get_own_cid( mbedtls_ssl_context *ssl,
                            int *enabled,
 ...
 */
MBEDTLS_EXPORT void mbedtls_ssl_set_export_keys_cb( mbedtls_ssl_context *ssl,
...
MBEDTLS_EXPORT void mbedtls_ssl_conf_tls13_key_exchange_modes( mbedtls_ssl_config* conf,
                                                const int kex_modes );
#endif /* MBEDTLS_SSL_PROTO_TLS1_3 */
 ...
 */
MBEDTLS_EXPORT void MBEDTLS_DEPRECATED mbedtls_ssl_conf_curves( mbedtls_ssl_config *conf,
 ...
 */
MBEDTLS_EXPORT void mbedtls_ssl_conf_groups( mbedtls_ssl_config *conf,
 ...
 */
MBEDTLS_EXPORT void MBEDTLS_DEPRECATED mbedtls_ssl_conf_sig_hashes( mbedtls_ssl_config *conf,
                                                     const int *hashes );
 ...
 */
MBEDTLS_EXPORT void mbedtls_ssl_conf_sig_algs( mbedtls_ssl_config *conf,
 ...
 *                 from which the client should select client peer certificate.
 */
MBEDTLS_EXPORT void mbedtls_ssl_set_hs_dn_hints( mbedtls_ssl_context *ssl,
                                  const mbedtls_x509_crt *crt );
#endif /* MBEDTLS_KEY_EXCHANGE_CERT_REQ_ALLOWED_ENABLED */
 ...
 */
MBEDTLS_EXPORT void mbedtls_ssl_conf_srtp_mki_value_supported( mbedtls_ssl_config *conf,
 ...
 */
MBEDTLS_EXPORT int mbedtls_ssl_conf_dtls_srtp_protection_profiles
                               ( mbedtls_ssl_config *conf,
 ...
 */
MBEDTLS_EXPORT int mbedtls_ssl_dtls_srtp_set_mki_value( mbedtls_ssl_context *ssl,
 ...
 */
MBEDTLS_EXPORT void mbedtls_ssl_get_dtls_srtp_negotiation_result( const mbedtls_ssl_context *ssl,
 ...
 */
MBEDTLS_EXPORT void MBEDTLS_DEPRECATED mbedtls_ssl_conf_max_version( mbedtls_ssl_config *conf, int major, int minor );
#endif /* MBEDTLS_DEPRECATED_REMOVED */
 ...
 *                 #MBEDTLS_SSL_MINOR_VERSION_4 for TLS 1.3)
 */
MBEDTLS_EXPORT void MBEDTLS_DEPRECATED mbedtls_ssl_conf_min_version( mbedtls_ssl_config *conf, int major, int minor );
#endif /* MBEDTLS_DEPRECATED_REMOVED */
 ...
 */
MBEDTLS_EXPORT void mbedtls_ssl_conf_preference_order( mbedtls_ssl_config *conf, int order );
#endif /* MBEDTLS_SSL_SRV_C */
 ...
 */
MBEDTLS_EXPORT int mbedtls_ssl_get_ciphersuite_id_from_ssl( const mbedtls_ssl_context *ssl );
 ...
 *                 or a negative error code.
 */
MBEDTLS_EXPORT int mbedtls_ssl_get_max_in_record_payload( const mbedtls_ssl_context *ssl );
 ...
 */
MBEDTLS_EXPORT int mbedtls_ssl_get_session( const mbedtls_ssl_context *ssl,
                             mbedtls_ssl_session *session );
#endif /* MBEDTLS_SSL_CLI_C */
