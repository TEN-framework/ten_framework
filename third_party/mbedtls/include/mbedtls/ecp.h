 ...
 * \return          Another negative error code on different kinds of failure.
 */
MBEDCRYPTO_EXPORT int mbedtls_ecp_write_key( mbedtls_ecp_keypair *key,
                           unsigned char *buf, size_t buflen );
 ...
 */
MBEDCRYPTO_EXPORT int mbedtls_ecp_check_pub_priv(
 ...
 * \return          Another negative error code on other kinds of failure.
 */
MBEDCRYPTO_EXPORT int mbedtls_ecp_export(const mbedtls_ecp_keypair *key, mbedtls_ecp_group *grp,
                       mbedtls_mpi *d, mbedtls_ecp_point *Q);
