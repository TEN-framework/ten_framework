 ...
 */
MBEDCRYPTO_EXPORT int mbedtls_rsa_set_padding( mbedtls_rsa_context *ctx, int padding,
 ...
 * \return         An \c MBEDTLS_ERR_RSA_XXX error code on failure.
 */
MBEDCRYPTO_EXPORT int mbedtls_rsa_rsassa_pss_sign_ext( mbedtls_rsa_context *ctx,
                         int (*f_rng)(void *, unsigned char *, size_t),
                         void *p_rng,
                         mbedtls_md_type_t md_alg,
                         unsigned int hashlen,
