 ...
 */
MBEDCRYPTO_EXPORT unsigned mbedtls_ct_uint_mask( unsigned value );
 ...
 * \return          Zero if \p value is zero, otherwise all-bits-one.
 */
MBEDCRYPTO_EXPORT size_t mbedtls_ct_size_mask( size_t value );
 ...
 *              otherwise zero.
 */
MBEDCRYPTO_EXPORT size_t mbedtls_ct_size_mask_ge( size_t x,
                                size_t y );
 ...
 */
MBEDCRYPTO_EXPORT unsigned mbedtls_ct_size_bool_eq( size_t x,
                                  size_t y );
 ...
 */
MBEDCRYPTO_EXPORT unsigned mbedtls_ct_mpi_uint_lt( const mbedtls_mpi_uint x,
 ...
 */
MBEDCRYPTO_EXPORT unsigned mbedtls_ct_uint_if( unsigned condition,
                             unsigned if1,
                             unsigned if0 );
 ...
 */
MBEDCRYPTO_EXPORT void mbedtls_ct_mpi_uint_cond_assign( size_t n,
 ...
 */
MBEDCRYPTO_EXPORT void mbedtls_ct_memcpy_if_eq( unsigned char *dest,
 ...
 * \param len           The number of bytes to copy.
 */
MBEDCRYPTO_EXPORT void mbedtls_ct_memcpy_offset( unsigned char *dest,
                               const unsigned char *src,
                               size_t offset,
                               size_t offset_min,
                               size_t offset_max,
...
MBEDCRYPTO_EXPORT int mbedtls_ct_hmac( mbedtls_svc_key_id_t key,
                     psa_algorithm_t alg,
...
#else
MBEDCRYPTO_EXPORT int mbedtls_ct_hmac( mbedtls_md_context_t *ctx,
                     const unsigned char *add_data,
                     size_t add_data_len,
                     const unsigned char *data,
                     size_t data_len_secret,
 ...
 */
MBEDCRYPTO_EXPORT int mbedtls_ct_rsaes_pkcs1_v15_unpadding( unsigned char *input,
                                          size_t ilen,
                                          unsigned char *output,
